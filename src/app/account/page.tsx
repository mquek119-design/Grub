...
export const metadata = {
  title: 'My Account · Grub',
  description: 'Manage your profile, dietary preferences, and house connection.',
};
...
export default async function AccountPage({
  ...
  const defaultTab: SettingsTab = params.tab === 'house' ? 'house' : 'profile';
